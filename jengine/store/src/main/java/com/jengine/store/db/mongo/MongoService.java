package com.jengine.store.db.mongo;
    ...
    public void init() {
        try {
            mongoClient = new MongoClient(
                    ...
                    Arrays.asList(MongoCredential.createMongoCRCredential(mongoConfig.getUsername(), mongoConfig.getDatabase(), mongoConfig.getPassword().toCharArray())),
