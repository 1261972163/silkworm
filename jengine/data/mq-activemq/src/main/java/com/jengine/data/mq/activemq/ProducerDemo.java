...
public class ProducerDemo {
    ...
    public void test1() {
        ...
        connectionFactory = new ActiveMQConnectionFactory(ProducerDemo.USERNAME, ProducerDemo.PASSWORD, ProducerDemo.BROKEURL);//实例化连接工厂
        try {
    ...
    public void pooledConnectionFactory() throws Exception {
        PooledConnectionFactory pooledConnectionFactory = new PooledConnectionFactory(ProducerDemo.BROKEURL);
        pooledConnectionFactory.setMaxConnections(10);
        pooledConnectionFactory.setIdleTimeout(60);
        pooledConnectionFactory.start();

        Connection connection = pooledConnectionFactory.createConnection(ProducerDemo.USERNAME, ProducerDemo.PASSWORD);
        connection.start();
        ...
        pooledConnectionFactory.setIdleTimeout(60);
        pooledConnectionFactory.start();
        connection = pooledConnectionFactory.createConnection(ProducerDemo.USERNAME, ProducerDemo.PASSWORD);
        connection.start();
