...
/**
 * clone helper Created by nouuid on 2015/5/14.
 */
public class CloneHelper {

  public static final Logger logger = LoggerFactory.getLogger(CloneHelper.class);
   ...
   *
   * @param value Object
   * @param level =0, the same Object <0, has the same value, but not the same Object >0, before
   *              level comes to 0, new Objct has the same value to provided Object
   * @return a new Object
   */
