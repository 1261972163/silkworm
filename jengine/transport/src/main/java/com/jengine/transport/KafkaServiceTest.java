...
import com.jengine.transport.kafka.KafkaService;
import com.jengine.transport.kafka.KafkaServiceImpl;
                ...
                public void run() {
                    ...
                    while (true) {
                        ...
                        for (ConsumerRecord<String, String> record : records) {
                            System.out.printf(cumserid + " offset = %d, key = %s, value = %s", record.offset(), record.key(), record.value());
                            System.out.println();
                            if (cumserid == 1) {
